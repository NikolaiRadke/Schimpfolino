...
What's new?  
* **18.10.2024** Firmware **1.01-181024** is working in the *new* sketches now. **Schimpfolino_noeeprom_new.ino** got 5x5 new words.    -- More news? See the [newsblog](https://github.com/NikolaiRadke/Schimpfolino/tree/main/NEWS.md).   
