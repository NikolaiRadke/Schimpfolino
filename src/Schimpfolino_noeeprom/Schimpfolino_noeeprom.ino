/*  
    ...
    Flash usage: 8.182 bytes (IDE 2.3.6 | ATTinyCore 1.5.2 | Linux X86_64 | ATtiny85)
...
// Wordlist arrays - a single array can hold only 4000 bytes | Used if no EEPROM present | 5 x 97 words = 4850 bytes
