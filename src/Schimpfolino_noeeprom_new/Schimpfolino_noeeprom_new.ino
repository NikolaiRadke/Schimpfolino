/*  
    ...
    Flash usage: 8.086 bytes (IDE 2.3.3 | ATTinyCore 1.5.2 | Linux X86_64 | ATtiny85)
...
// Wordlist arrays - a single array can hold only 4000 bytes | Used if no EEPROM present | 5 x 95 words = 4750 bytes
