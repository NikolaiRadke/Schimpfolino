...
const char data3[] PROGMEM = {"suppe     socke     bombe     boulette  schwarte  warze     beule     pest      pflaume   r^be      "
                              ...
                              "pelle     trine     queen     zecke     praline   magt      pracht    fritte    so_e      larve     "
...
const char data5[] PROGMEM = {"sekret    balg      blag      monster   gel]t     imitat    skelett   ding      unding    auge      "
                              ...
                              "mittel    geschnetz organ     risotto   vieh      ges[_     gez^cht   ekzem     moped     ger^mpel  "
                              "hirn      gef[_     wachstum  moloch    rinnsaal  gemenge   opossum   frettchen h[hnchen  plankton  "
